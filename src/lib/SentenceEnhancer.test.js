...
test('basic sentence parse', async () => {
    ...
    const resultSentence = await parser.enhance(inputSentence);
    ...
    const expectedSentence = new Sentence(expectedTokens);

    expect(resultSentence).toEqual(expectedSentence);
    expect(inputSentence).toEqual(expectedSentence.text);
});